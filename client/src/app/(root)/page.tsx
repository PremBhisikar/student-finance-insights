    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        >
          ...
          Financial <span className="text-primary">Intelligence</span> for Smarter Decisions
        </h1>

          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-4/5 mx-auto text-balance">
            Analyze spending patterns, financial discipline, and trends through structured insights and real-time analytics.
          </p>
        </motion.div>
        ...
        >
          {[
            ...
            desc: "Identify recurring trends and understand where your money actually goes",
          },
          {
            title: "Financial Discipline Tracking",
            desc: "Measure consistency against planned financial goals over time",
          },
          {
            title: "Insightful Visual Analytics",
            desc: "Interpret financial data through interactive and meaningful visualizations",
          },
          ].map((feature, idx) => (
            <motion.div
              key={idx}
